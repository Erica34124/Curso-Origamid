...
<body>
    ...
    <section class="grid-section animais js-scroll" id="animais">
        ...
        <div class="animais-descricao js-tabcontent">
            ...
            <section>
                <h2>Urso</h2>
                <p>
                    Lorem, ipsum dolor sit amet consectetur adipisicing elit. Tempore, distinctio eligendi commodi obcaecati delectus, corrupti maxime perspiciatis asperiores sed ipsum fugiat temporibus, velit voluptatum. Nisi praesentium provident inventore at nostrum.</p>
            </section>
            <section>
                <h2>Lobo</h2>
                <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Tempore, distinctio eligendi commodi obcaecati delectus, corrupti maxime perspiciatis asperiores sed ipsum fugiat temporibus, velit voluptatum. Nisi praesentium provident inventore at nostrum.</p>
    ...
    <section class="grid-section fac js-scroll" id="faq">
        <h1 class="titulo">Faq</h1>
        <dl class="faq-lista js-accordeon" id="faq-lista">
            <dt>Qual a idade dos animais</dt>
            <dd>As raposas são animais mamiferos a oniveros pertencentes a ...</dd>
            <dt>Qual a idade dos animais</dt>
            <dd>Testando dd 2 shah shah shah</dd>
            <dt>Qual a idade dos animais</dt>
            <dd>Testando dd 3 shah shah shah</dd>
            <dt>Qual a idade dos animais</dt>
            <dd>Testando dd 4 shah shah shah</dd>
        </dl>
